...
// ACE_HUNTIR is the classname of the huntir ammo
...
// We need to spawn a new process to manage infiny loop.
[_satelitte, _satelittePosX, _satelittePosY, _satelittePosZ] spawn {
	...
	while {true} do {
		// replace the huntir ammo at the position each 0.3 seconds
